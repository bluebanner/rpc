...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('packages/bluebanner/rpc/css/bootstrap.min.css') }}" type="text/css" media="screen" charset="utf-8">
	...
	<link rel="stylesheet" href="{{ asset('packages/bluebanner/rpc/css/pages/signin.css') }}" type="text/css" media="screen" charset="utf-8">
...
<body>
		...
		<div class="navbar-inner">
			...
			<div class="container">
				...
				<a class="brand" href="{{ URL::to(Config::get('rpc::uri')) }}">
					RPC <sup>{{Config::get('application.version')}}</sup>				
				</a>		
				...
				<div class="nav-collapse">
					<ul class="nav pull-right">
						...
						<li class="">						
							<a href="{{ URL::to(Config::get('rpc::uri')) }}" class="">
